    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="container-fluid">
                <!-- Tabla para Subastas Cerradas -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="container-fluid mt-5">
                            <!-- Tabla para Subastas Cerradas -->
                            <div class="table-responsive shadow-sm p-4 bg-white rounded">
                                <h2 class="mb-5 text-center text-black">Subastas Cerradas</h2>
                                <hr>
                                <table class="table table-hover table-striped align-middle">
                                    <thead class="table-dark">
                                        <tr>
                                            ...
                                            <th class="h4 fw-bold">Última Oferta</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        // Subastas Cerradas del Usuario
                                        $res = $conex->query("SELECT * FROM subastas WHERE estado = 1 AND creador = $idCliente ");
                                        if ($res && $res->num_rows > 0) {
                                            ...
                                            echo "<tr><td colspan='4' class='text-center text-muted'>No hay subastas cerradas.</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
