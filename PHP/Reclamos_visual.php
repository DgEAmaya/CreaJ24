  ...
  if ($conex==true) {
    ...
    if ($sql){
        while ($row = $resultado->fetch_array()){
            ...
            $mensaje         = $row['mensaje'];
            $fecha           = $row['fecha'];
        // proceso para mostrar los datos en la tabla
  ?>
  <tbody>
    <tr class="text-center">
      <th> <?php echo $PrimerNombre, " ", $PrimerApellido?> </th>
      <th> <?php echo $correo?> </th>
      <th> <?php echo $telefono?> </th>
      <th> <?php echo $direccion?> </th>
      <th> <?php echo $mensaje?> </th>
      <th> <?php echo $fecha?></th>
      <th> <a class="visual" href="contesta_reclamos.php?=<?php echo $row['idReclamos'] ?>"><button class="btn reseñasbtn btn-warning"><i class="bi bi-pencil-fill"></i></button></a> </th>           
    </tr>
  </tbody>
  <?php 
            }
