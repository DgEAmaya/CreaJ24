...
?>  
 ...
 <!-- Imagen Moda -->
 <img src="../Imagenes/3.png" width="100%"  class="img-fluid max-width: 100%;" alt="imgDonaciones">  
 ...
 <section>
  <div class="container">
    ...
    <div class="main-content">
        ...
        <?php
        $categorias = ["Moda Urbana"]; // Ajusta las categorías según tu base de datos

        foreach ($categorias as $categoria) :
            $query = "SELECT * FROM subastas WHERE categoria_producto='Moda Urbana' LIMIT 4"; // Ajusta la consulta según tu base de datos
