...
<head>
  ...
  <title>Solicitudes Inspector</title>
...
?>
<img src="../Imagenes/Inspecciones.png" width="100%"  class="img-fluid max-width: 50%;" alt="imgDonaciones">  


<div class="containerSoli">
        <h1 class="mt-4 text-center">Solicitudes de Donación</h1>
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                $sql = "SELECT * FROM solicitardonacion where estado = 'pendiente'";
                    ...
                    if ($result === false) {
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                // Botón de Aprobar
                                echo '<a href="procesar-solicitud.php?action=aceptar&idReceptor=' . $row["idReceptor"] . '" class="btn btn-success btn-sm">Aprobar</a>';

                                // Botón de Rechazar
                                echo '<a href="procesar-solicitud.php?action=rechazar&idReceptor=' . $row["idReceptor"] . '" class="btn btn-danger btn-sm">Rechazar</a>';
...
<script src="../js/moodoscuro.js"></script>
...
<footer>
    <div class="footer-wrapper">
        <div class="footer-columns">
            ...
            <div class="FootDesarr text-center">
                <div>
