...
@$SegundoNombre = $_SESSION['SegundoNombre'];
...
<style>
    ...
    <nav class="vertical-nav" id="sideMenu">
        <div class="collapse show" id="menuItems">
            <ul class="navbar-nav flex-column mt-5">
                <li class="nav-item">
                    <a class="nav-link ps-4 mr-4" href="../PHP/index.php"> <i class="bi bi-house-door-fill paraFueradeElotrodiv3 "></i> Inicio</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="collapse" id="cateMenu">
                        <ul class="navbar-nav">
                            <li><a class="dropdown-item" href="../PHP/Entretenimiento.php">Entretenimiento</a></li>
                            <li><a class="dropdown-item" href="../PHP/Moda.php">Moda Urbana</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="collapse" id="subMenu">
                        <ul class="navbar-nav">
                            <li><a class="dropdown-item" href="../PHP/CrearSubasta.php">Crear</a></li>
                            <li><a class="dropdown-item" href="../PHP/misSubastas.php">Mis Subastas</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="collapse" id="donaMenu">
                        <ul class="navbar-nav">
                            <li><a class="dropdown-item" href="../PHP/RealizarDona.php">Realizar</a></li>
                            <li><a class="dropdown-item" href="../PHP/SolicitudesDona.php">Solicitar</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                <a class="nav-link ps-4" href="../PHP/Reclamos.php">
    <i class="fas fa-file-alt paraFueradeElotrodiv icon-margin"></i> Reclamos
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle ps-4" href="../HTML/Contactanos.html" id="contactoDropdown" role="button" data-bs-toggle="collapse" data-bs-target="#contaMenu" aria-expanded="false" aria-controls="subMenu">
                        <i class="fas fa-envelope"></i> Contáctanos <i class="bi bi-caret-down-fill"></i>
                    </a>
                    <div class="collapse" id="contaMenu">
                        <ul class="navbar-nav">
                            <li><a class="dropdown-item" href="Contactanos.php">Correo Electronico</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link ps-4" href="#"> <i class="fas fa-shield-alt paraFueradeElotrodiv2 icon-margin"></i>Políticas</a>
                </li>
            </ul>
