...
if (isset($_POST['btn_enviar'])) {
    $mensajecontestar = trim($_POST['mensajecontestar']);

     
    $sql = "INSERT INTO reclamoscontestar (mensajecontestar) VALUES ('$mensajecontestar')";
     $resultado = mysqli_query($conex,$sql);
    if ($resultado){
      ?>   
    <script>alert("Su resppuesta ha sido enviada")</script>
      <?php 
    }else{
    
      ?>
        <script>alert("Error en el envio de su soliitud")</script>
...
?>  
 ...
 <!-- aqui termina el menu -->
  ...
  <section class="margenesdelformulario ">
    <div class="FormReclamos text-black mx-auto d-flex justify-content-center">
    
      <form class="Formularios" method="POST">
  
        <div class="d-flex align-items-center mb-3 pb-1">
          <span class="h1 fw-bold mb-0">Formulario de Respuesta</span>
        </div>

        <div class="pt-1 mb-4">
        <div data-mdb-input-init class="form-outline mb-4 w-100 h-50">
          <label class="form-label" for="mensaje">Mensaje</label>
          <input type="text" id="mensaje" name="mensajecontestar" class="mensajeReclamo form-control form-control-lg border border-dark" />
        </div>
